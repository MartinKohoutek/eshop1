        ...
        <div class="main-body">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('update.banner', $banners->id) }}" method="post" enctype="multipart/form-data" id="myForm">
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" name="banner_subtitle" class="form-control" value="{{ $banners->banner_subtitle }}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img src="{{ (!empty($banners->banner_image)) ? asset($banners->banner_image) : url('upload/no_image.jpg') }}" alt="Admin" class="p-1 bg-primary" style="width: 150px; height: 150px" id="showImage">
                                    </div>
                                </div>
                                <div class="row">
