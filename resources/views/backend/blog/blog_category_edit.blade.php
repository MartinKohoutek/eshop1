        ...
        <div class="main-body">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('update.blog.category') }}" method="post" id="myForm">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" name="blog_category_name" class="form-control" value="{{ $category->blog_category_name }}"/>
                                    </div>
                                </div>
                                <div class="row">
