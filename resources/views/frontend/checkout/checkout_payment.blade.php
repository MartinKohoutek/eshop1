                                ...
                                <form action="{{ route('checkout.store') }}" method="post">
                                    ...
                                    <div class="card-body">
                                        <ul class="nav nav-pills mb-3 border p-3" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link rounded-0" data-bs-toggle="pill" href="#cash-on-delivery" role="tab" aria-selected="false">
                                                    <div class="d-flex align-items-center">
                                                        <div class="tab-icon"><i class='bx bx-mobile font-18 me-1'></i>
                                                        </div>
...
<script type="text/javascript">
    ...
    var stripe = Stripe('pk_test_51Nk1tSJDg5Rja1Q8AbRlHWH9FYsOVC5wzzJdZFktWodCZW0MxofYurtkAsuuCLMOve8OqqytELpu5FuAKQyWTCWF00uzqYiziK');
