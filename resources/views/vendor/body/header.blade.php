        ...
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="user-box dropdown px-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="{{ route('vendor.change.password') }}"><i class="bx bx-cog fs-5"></i><span>Change Password</span></a>
                    </li>
                    ...
                    <li><a class="dropdown-item d-flex align-items-center" href="{{ route('vendor.logout') }}"><i class="bx bx-log-out-circle"></i><span>Logout</span></a>
                    </li>
                </ul>
            </div>
        </nav>
